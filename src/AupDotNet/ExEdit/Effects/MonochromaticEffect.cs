...
namespace Karoterra.AupDotNet.ExEdit.Effects
{
    ...
    public class MonochromaticEffect : Effect
    {
        ...
        /// <summary>
        /// <see cref="MonochromaticEffect"/> のインスタンスを初期化します。
        /// </summary>
        ...
        /// <summary>
        /// トラックバーとチェックボックスの値を指定して <see cref="MonochromaticEffect"/> のインスタンスを初期化します。
        /// </summary>
        ...
        /// <summary>
        /// トラックバーとチェックボックス、拡張データを指定して <see cref="MonochromaticEffect"/> のインスタンスを初期化します。
        /// </summary>
        /// <param name="trackbars">トラックバー</param>
        /// <param name="checkboxes">チェックボックス</param>
