...
namespace Karoterra.AupDotNet.ExEdit.Effects
{
    ...
    public class ParticleEffect : Effect
    {
        ...
        /// <summary>
        /// <see cref="ParticleEffect"/> のインスタンスを初期化します。
        /// </summary>
        ...
        /// <summary>
        /// トラックバーとチェックボックスの値を指定して <see cref="ParticleEffect"/> のインスタンスを初期化します。
        /// </summary>
        ...
        /// <summary>
        /// トラックバーとチェックボックス、拡張データを指定して <see cref="ParticleEffect"/> のインスタンスを初期化します。
        /// </summary>
        /// <param name="trackbars">トラックバー</param>
        /// <param name="checkboxes">チェックボックス</param>
